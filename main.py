...
def cloneRepo(repoUrl: str = "https://github.com/404-5971/luigisHomework") -> None:
...
def main() -> None:
    ...
    def index():
        ...
        with open(
            "/home/daniel/Documents/myCode/luigisHomeworkWebViewer/luigisHomework/myCode/age.py",
            "r",
        ) as file:
            code = file.read()
        ...
        return render_template(
            "index.html", code=highlighted_code, css_styles=css_styles
        )
